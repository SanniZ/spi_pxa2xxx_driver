...
/* Vendor specific devIdle capability */
#define PCI_VNDR_DEVIDLE_CPTR	0xc	/* mmio devIdle register */
#define PCI_VNDR_DEVIDLE_GET_BARNUM(x)	(((x) & 0xe) >> 1)
#define PCI_VNDR_DEVIDLE_GET_OFFSET(x)	((x) >> 4)
#define PCI_VNDR_DEVIDLE_MASK		2
#define PCI_VNDR_DEVIDLE_RR_MASK	8

#define PCI_VNDR_DEVIDLE_LTR    0x8	/* mmio devidle ltr register */
#define DEVIDLE_ACTIVE_SW_LTR   0x0
#define DEVIDLE_IDLE_SW_LTR     0x4
#define DEVIDLE_LTR_REQ         BIT(15)
#define DEVIDLE_LTR_SCALE_MASK  0xc00
#define DEVIDLE_LTR_VALUE_MASK  0x3ff
#define DEVIDLE_LTR_SCALE_32US  0xc00
#define DEVIDLE_LTR_SCALE_1US   0x800
